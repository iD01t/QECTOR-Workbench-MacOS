...
**Workbench 1.0.0 - Backend `qector_decoder_v3` 1.0.0 (min 1.0.0) - 82 MCP tools - 16 decoders - 10 code families**
**Decoder package: `qector_decoder_v3` 1.0.0 (bundled wheel, activated offline on first launch)**
Generated 2026-08-04T08:45:10+00:00Z
...
### `autodebug.field(*, default=<dataclasses._MISSING_TYPE object at 0x000002B2FF3345D0>, default_factory=<dataclasses._MISSING_TYPE object at 0x000002B2FF3345D0>, init=True, repr=True, hash=None, compare=True, metadata=None, kw_only=<dataclasses._MISSING_TYPE object at 0x000002B2FF3345D0>)`
...
82 tools via stdio JSON-RPC 2.0.
